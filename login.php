        ...
        <div class="layer-wrapper"> 
            <form method="POST" action="login.php">
                ...
                <div class="mdl-textfield mdl-js-textfield mdl-textfield--floating-label form-input-icon">
                    ...
                    <input class="mdl-textfield__input" type="text" pattern="[a-z0-9._%+-]+@[a-z0-9.-]+\.[a-z]{2,3}$" id="login-email" name="email">
                ...
                <div class="form-submit">
                    <button class="mdl-button mdl-js-button mdl-js-ripple-effect button button-primary" name="submit">Login Now</button>
                </div>
                ...
                <div class="login-link">
                    ...
                    <a href="register.php" class="">Register as New User</a>
                </div>
            </div>
            </form>
